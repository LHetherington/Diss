...
// grab the settings from the database and merge with $set
...
foreach ($columns as $key => $value) {
  ...
  if(in_array($key, array("register", "email_validation"))) // add in this array columns that you want to have enabled/disabled select menu
  echo "
